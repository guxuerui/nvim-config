...
local buttons = {
  ...
  val = {
    ...
    dashboard.button("C", "⚙️   Config lua", ":e ~/.config/nvim/lua/options.lua <CR>"),
    dashboard.button("m", "⌨️   Key mappings", ":e ~/.config/nvim/lua/keymaps.lua <CR>"),
    dashboard.button("p", "💼  Plugins", ":e ~/.config/nvim/lua/plugins.lua <CR>"),
    dashboard.button("t", "📺  Start Screen", ":e ~/.config/nvim/after/plugin/startup-screen.rc.lua <CR>"),
